...
- lpN=6, 7は1.17, 1.34cycで、これはlpN+1個のμopをRATに通すだけでかかるcycである(lpN+1)/6 = 1.17, 1.33とほぼ一致します。つまり純粋にAllocate帯域律速です。
...
- 前回「どこまで性能向上に役立つのか分からない」と書きましたがいろいろなところで現れる「演算の最後のオフセット計算」で効果があるのかもしれません。
