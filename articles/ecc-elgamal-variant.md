...
### 欠点その2
平文 $M$ を $(𝔽_p)^2$ の元として計算するということは、暗黙にアフィン座標を仮定しているので無限遠点は表現できません。たとえば「$O=(0,0)$ とする」というような恣意的な設定が必要です。
...
楕円ElGamal暗号の準同性を捨てて、IND-CCA2安全な方向に進んだものとしてはPSEC-KEMやCramer-Shoup暗号などがあります。
